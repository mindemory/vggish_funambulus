  ...
  for k, (train_index, test_index) in enumerate(sss.split(X, y)):
    ...
    for j in y_test:
      if j == 'MOFA':
        ...
        poho_test += 1
    print("mofa_train = {}, fini_train = {}, cuce_train = {}, phma_train = {}, pyjo_train = {}, poho_train = {}".format(mofa_train, fini_train, cuce_train, phma_train, pyjo_train, poho_train))
    print("mofa_test = {}, fini_test = {}, cuce_test = {}, phma_test = {}, pyjo_test = {}, poho_test = {}".format(mofa_test, fini_test, cuce_test, phma_test, pyjo_test, poho_test))
