...
for depth in DEPTH: 
  for tree_count in TREES:      
    for noise_value in NOISE:   
      ...
      clf = rf_classifier_aru(SQUIRRELS, species_training, noise_value, tree_count, depth, randomstate)   
      ...
      for day in days:
        ...
        save_folder = Project_path+'Detections/'+str(noise_value)+'noise_'+str(tree_count)+'trees'+str(depth)+'_classifier/' 
