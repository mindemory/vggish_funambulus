...
from neural_network_classifier import train_model, get_model
...
NEURONS0 = [3, 5, 10, 50, 65, 100, 128, 150]
#NEURONS1 = [5000]
ACTIVATION_FUNCTIONS = ['relu', 'selu', 'elu', 'tanh', 'sigmoid', 'exponential']
...
for neurons0 in NEURONS0:
  for activation_function in ACTIVATION_FUNCTIONS:
    for optimizer in OPTIMIZERS:
      ...
      with strategy.scope():
        model = get_model(neurons0, neurons1, activation_function, input_shape)
      ...
      for day in days:
        ...
        save_folder = Project_path + 'Detections_neural_network_classifier/layer_1/'+str(neurons0)+'_neurons0_'+activation_function+'_'+optimizer+'_classifier/'
