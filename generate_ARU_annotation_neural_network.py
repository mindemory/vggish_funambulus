    ...
    for optimizer in OPTIMIZERS:
      for noise in NOISE:
        ...
        for day in days:
          ...
          save_folder = Project_path + 'Detections_neural_network_classifier/layer1/'+str(neurons0)+'_neurons0_'+activation_function+'_'+optimizer+'_' +str(noise)+'_noise_classifier/'
